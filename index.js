...
window.addEventListener("load", () => {
    ...
    searchInput.addEventListener("input", () => {
        ...
        if (!query) return (container.style.opacity = 0, container.style.pointerEvents="none")
        else (container.style.opacity = 100, container.style.pointerEvents="revert-layer")
